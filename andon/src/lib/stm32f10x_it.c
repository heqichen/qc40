...
/**
	...
	* @retval None
	*/
volatile unsigned long __coobocMs;

void SysTick_Handler(void)
{
	__coobocMs++;
}
void timer2InterruptService(void);

void TIM2_IRQHandler(void)
{
	timer2InterruptService();
}
...
{
	I2C2EventInturruptService();
}
void I2C2_ER_IRQHandler(void)
{
	I2C2ErrorInturruptService();
}
